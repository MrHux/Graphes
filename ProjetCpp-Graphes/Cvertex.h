...
public:
	...
	*
	*******************************************************************************/
	Cvertex(unsigned int uiId_vertex, Cedges ** ppList_edges_out, Cedges ** ppList_edges_in, unsigned int uiNb_edges_out, unsigned int uiNbedges_in) throw (Cexception);
