...
${OBJECTDIR}/Cedges.o: Cedges.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cedges.o Cedges.cpp

${OBJECTDIR}/Cedges_UNIT.o: Cedges_UNIT.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cedges_UNIT.o Cedges_UNIT.cpp

${OBJECTDIR}/Cexception.o: Cexception.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cexception.o Cexception.cpp

${OBJECTDIR}/Cfile.o: Cfile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cfile.o Cfile.cpp

${OBJECTDIR}/Cfile_UNIT.o: Cfile_UNIT.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cfile_UNIT.o Cfile_UNIT.cpp

${OBJECTDIR}/Cfile_gvedit.o: Cfile_gvedit.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cfile_gvedit.o Cfile_gvedit.cpp

${OBJECTDIR}/Cgraph.o: Cgraph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cgraph.o Cgraph.cpp

${OBJECTDIR}/Cgraph_UNIT.o: Cgraph_UNIT.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cgraph_UNIT.o Cgraph_UNIT.cpp

${OBJECTDIR}/Cgraph_table.o: Cgraph_table.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cgraph_table.o Cgraph_table.cpp

${OBJECTDIR}/Cgraph_table_UNIT.o: Cgraph_table_UNIT.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cgraph_table_UNIT.o Cgraph_table_UNIT.cpp

${OBJECTDIR}/Cmax_inde_sets_table.o: Cmax_inde_sets_table.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cmax_inde_sets_table.o Cmax_inde_sets_table.cpp

${OBJECTDIR}/Cmax_inde_sets_table_UNIT.o: Cmax_inde_sets_table_UNIT.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cmax_inde_sets_table_UNIT.o Cmax_inde_sets_table_UNIT.cpp

${OBJECTDIR}/Cvertex.o: Cvertex.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cvertex.o Cvertex.cpp

${OBJECTDIR}/Cvertex_UNIT.o: Cvertex_UNIT.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cvertex_UNIT.o Cvertex_UNIT.cpp
